...
def schemaName_spider(request, tableName):
    if request.method in ["POST", "GET"]:
        ...
        # Linux
        cmd = "cd /yykj/python/9999/spider7v5j1xt0 && scrapy crawl "+tableName+"Spider -a databaseName=djangojo447qt5"
        # Windows
        # cmd = "cd C:\\test1\\spider && scrapy crawl " + tableName + "Spider -a databaseName=djangojo447qt5"
        os.system(cmd)
