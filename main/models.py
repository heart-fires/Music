...
class yinlefenlei(BaseModel):
    ...
    __isAdmin__='否'#表属性isAdmin=”是”,刷出来的用户表也是管理员，即page和list可以查看所有人的考试记录(同时应用于其他表)
    addtime = models.DateTimeField(auto_now_add=False, verbose_name=u'创建时间')
    yinlefenlei=models.CharField ( max_length=255, null=True,unique=True, verbose_name='音乐分类' )
    '''
    yinlefenlei=VARCHAR
    '''
    class Meta:
...
class yinlexinxi(BaseModel):
    ...
    yinlefenlei=models.CharField ( max_length=255,null=False, unique=False, verbose_name='音乐分类' )
    singer=models.CharField ( max_length=255,null=False, unique=False, verbose_name='歌手' )
    bianqu=models.CharField ( max_length=255,null=False, unique=False, verbose_name='编曲' )
    tianci=models.CharField ( max_length=255,null=False, unique=False, verbose_name='填词' )
    ...
    geci=models.TextField   (  null=True, unique=False, verbose_name='歌词' )
    thumbsupnum=models.IntegerField  (  null=True, unique=False,default='0', verbose_name='赞' )
    crazilynum=models.IntegerField  (  null=True, unique=False,default='0', verbose_name='踩' )
...
class gequxinxi(BaseModel):
    ...
    class Meta:
        db_table = 'gequxinxi'
        verbose_name = verbose_name_plural = '歌曲数据'
...
class discussgequxinxi(BaseModel):
    ...
    class Meta:
        ...
        verbose_name = verbose_name_plural = 'gequxinxi评论表'
